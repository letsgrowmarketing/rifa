                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-900 dark:text-white">{details.user.email}</p>
                        </div>
                        <div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <p className="text-gray-900 dark:text-white">{formatDate(details.user.data_cadastro)}</p>
                        </div>
                        <div>
                          ...
                          {details.vouchers.map((voucher) => (
                            <div key={voucher.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                              <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">{formatDate(voucher.data_envio)}</p>
                              </div>
